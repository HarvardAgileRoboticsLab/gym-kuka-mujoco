...
envs = [gym.make('RemoteCenterPegInsertionNoHole-v0') for _ in range(num_env)]
...
try:
    ...
    actor_options['tensorboard_log'] = os.path.join(tensorboard_logdir,'RemoteCenterPegInsertionNoHole-v0')
    print('\t--learning')
